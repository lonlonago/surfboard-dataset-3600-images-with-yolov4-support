# Surfboard dataset (3600 images) with YOLOv4 support.

# Body

Surfboard dataset (3600 images
Supports YOLO format
Images are clear and labeled comprehensively
Ideal for training target detection models, computer vision, motion scene analysis, etc.
